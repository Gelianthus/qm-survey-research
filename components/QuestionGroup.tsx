  ...
  return (
    <div className="bg-white rounded-lg shadow-sm px-4 sm:px-6 py-5 space-y-5">
      ...
      <div className="space-y-1">
        ...
        >
          {questionBlock.questions[2]}{" "}  <span className="text-gray-400 text-xs">(Optional)</span>
        </label>
        <textarea
          ...
          className="w-full border-b border-gray-300 focus:border-[#7248b9] outline-none text-sm py-1.5 text-gray-800 placeholder:text-gray-300 resize-none transition-colors bg-transparent"
        />
      </div>
    </div>
  );
